...
const url = `mongodb+srv://ncacciavillani:${password}@cluster0.owy48zj.mongodb.net/phonebookApp?retryWrites=true&w=majority&appName=Cluster0`;
...
mongoose
  ...
  .then(() => {
    ...
    console.log(" ");
    if (process.argv.length === 3) {
      // Condition === Only password passed
      ...
      // Condition === password, name and phone passed
